/**
 * Нормализация наименований моделей оборудования согласно п.8.3.
 *
...
export function normalizeModelCode(
  ...
  // говорит про разделение характеристик буквой «х», а не про букву X
...
/** Нормализация наименования класса/подкласса. */
...
/**
 * Нормализация наименования операции:
 *  1. С заглавной буквы.
 *  2. Им.падеж ед.число.
...
/**
 * Нормализация наименования характеристики:
...
/**
 * Нормализация единицы измерения (п.8.6 + ГОСТ 8.417).
